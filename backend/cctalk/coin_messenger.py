...
class CoinMessenger(object):
    ...
    r_info = dict(reset_device=(1, 0, bool),
                  ...
                  inhibit_status=(230, 2, str),
                  read_input_lines=(237, 6, int),          # Fuer Rueckgabeknopf
    ...
    def __init__(self, serial_object):
        ...
        for k, v in list(self.r_info.items()):
            ...
            byte_msg = list(map(self.integerToByte, int_msg))
    ...
    def read_buffer(self, verbose=True):
        ...
        """
        return self.request('read_buffered_credit_or_error_codes',verbose)
